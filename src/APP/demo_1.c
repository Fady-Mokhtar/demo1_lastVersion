...
{
    USART_startTransmit_IT(&usart1Manager, &UARTFRAME, (uint16_t)0x02);
}
/***************************************************************************************/
...
// {
//     USART_Receive_DMA(&usart1Manager, &dma_Buffer, (uint16_t)0x01);
// }

// void dma_transmit_runnable()
// {
//     USART_Transmit_DMA(&usart1Manager, &dma_Frame, (uint16_t)0x01);
// }
/******************************************************************************************/
int main(void)
{
